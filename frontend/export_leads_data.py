...
FIELD_MAP = {
    ...
    "Executive email": "executiveEmail",
    "Executive email status": "executiveEmailStatus",
    "Executive verification status": "executiveVerificationStatus",
    ...
    "Technical/R&D email": "technicalEmail",
    "Technical/R&D email status": "technicalEmailStatus",
    "Technical/R&D verification status": "technicalVerificationStatus",
    ...
    "Quality/QA email": "qualityEmail",
    "Quality/QA email status": "qualityEmailStatus",
    "Quality/QA verification status": "qualityVerificationStatus",
    "LinkedIn contact status": "linkedinContactStatus",
    "LinkedIn resolved website": "linkedinResolvedWebsite",
    "LinkedIn search provider": "linkedinSearchProvider",
    "LinkedIn company error": "linkedinCompanyError",
    "LinkedIn contact error": "linkedinContactError",
