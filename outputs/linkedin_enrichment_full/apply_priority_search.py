...
RESULTS = HERE / "priority_search_enrichment.json"
OUTPUT = HERE / "BlueBridge_TOFU_BizDev_V1_LinkedIn_Priority_Search.xlsx"
...
def main() -> None:
    ...
    if len(results) != 23:
        raise RuntimeError(f"Expected exactly 23 priority results, got {len(results)}")
