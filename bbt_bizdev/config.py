...
SOURCES: list[Source] = [
    ...
    Source("Creative Destruction Lab Health", "Accelerator", "https://creativedestructionlab.com/companies/", "EU/UK/Canada/global", "High", "Annual", "Company directory extraction", "Deeptech accelerator company directory filtered to health, biomedical engineering, cancer, computational health, and related streams.", "cdl_health"),
