...
ADAPTER_STATUS_NAMES = {
    ...
    "mit_spinouts": "MIT university spinout adapter",
    "harvard_ventures": "Harvard ventures directory adapter",
...
LINKEDIN_ENRICHMENT_CACHE_VERSION = "linkedin_enrichment_v3"
...
UNIVERSITY_SPINOUT_SOURCE_PAGES = {
    ...
    "Harvard spinouts": [
        "https://innovationlabs.harvard.edu/ventures/",
        "https://innovationlabs.harvard.edu/ventures/p2",
        "https://innovationlabs.harvard.edu/ventures/p3",
        "https://innovationlabs.harvard.edu/ventures/p4",
    ],
}
...
SOURCES: list[Source] = [
    ...
    Source("AUTM Licensing Survey / STATT", "Institution prioritization", "https://autm.net/surveys-and-tools/databases", "US/Canada", "High", "Annual", "Manual ranking review", "Institution-level technology transfer, licensing, patent, research funding, staffing, and startup output data. Use for US source prioritization; not a lead-ready company directory."),
    Source("BRIMR NIH rankings", "Institution prioritization", "https://brimr.org/brimr-rankings-of-nih-funding-in-2025/", "US", "High", "Annual", "Manual ranking review", "NIH funding rankings for biomedical institutions, schools, departments, hospitals, and PIs. Use to prioritize biomedical-heavy US institutions before adding company-level source pages."),
    ...
    Source("MIT spinouts", "University/spinout", "https://tlo.mit.edu/industry-entrepreneurs/startups/", "US", "High", "Quarterly", "Spinout/company page review", "MIT Technology Licensing startup directory for AI, engineering, device, diagnostics, and health spinouts.", "mit_spinouts"),
    Source("Harvard spinouts", "University/spinout", "https://innovationlabs.harvard.edu/ventures/", "US", "High", "Quarterly", "Spinout/company page review", "Harvard Innovation Labs venture directory for translational healthcare, diagnostics, digital health, and life-sciences ventures.", "harvard_ventures"),
    Source("Mass General Brigham spinouts", "University/spinout", "https://innovation.massgeneralbrigham.org/", "US", "High", "Quarterly", "Spinout/company page review", "Mass General Brigham Innovation source for clinician-led, hospital-origin medtech, diagnostics, digital health, and therapeutics ventures."),
    Source("Broad Institute ventures", "University/spinout", "https://www.broadinstitute.org/partnering", "US", "High", "Quarterly", "Spinout/company page review", "Broad Institute partnering source for genomics, diagnostics, computational biology, and translational biotech ventures."),
    ...
    Source("CHOP spinouts", "University/spinout", "https://www.chop.edu/research/office-technology-transfer", "US", "High", "Quarterly", "Spinout/company page review", "Children's Hospital of Philadelphia technology transfer source for pediatric devices, diagnostics, digital health, and translational clinical ventures."),
    Source("University of Washington spinouts", "University/spinout", "https://comotion.uw.edu/", "US", "High", "Quarterly", "Spinout/company page review", "UW CoMotion source for health, AI, diagnostics, medical devices, and translational research startups."),
    Source("Fred Hutch spinouts", "University/spinout", "https://www.fredhutch.org/en/research/technology-transfer.html", "US", "High", "Quarterly", "Spinout/company page review", "Fred Hutch technology transfer source for cancer diagnostics, therapeutics, immunology, and translational life-sciences companies."),
    Source("University of Michigan spinouts", "University/spinout", "https://innovationpartnerships.umich.edu/", "US", "High", "Quarterly", "Spinout/company page review", "University of Michigan Innovation Partnerships source for health, diagnostics, engineering, and medical technology startups."),
    Source("Duke University spinouts", "University/spinout", "https://otc.duke.edu/", "US", "High", "Quarterly", "Spinout/company page review", "Duke Office for Translation & Commercialization source for clinician-led health, medtech, diagnostics, and life-sciences ventures."),
    Source("UNC Chapel Hill spinouts", "University/spinout", "https://innovate.unc.edu/", "US", "Medium", "Quarterly", "Spinout/company page review", "UNC innovation source for life-sciences, diagnostics, digital health, and research commercialization startups."),
    Source("NC State spinouts", "University/spinout", "https://research.ncsu.edu/commercialization/", "US", "Medium", "Quarterly", "Spinout/company page review", "NC State commercialization source for biomedical engineering, device, diagnostics, and engineering-led health startups."),
    Source("UC San Diego spinouts", "University/spinout", "https://innovation.ucsd.edu/", "US", "High", "Quarterly", "Spinout/company page review", "UC San Diego innovation source for health AI, diagnostics, device, digital health, and translational biotech startups."),
    Source("Scripps Research spinouts", "University/spinout", "https://www.scripps.edu/science-and-medicine/technology-development/", "US", "High", "Quarterly", "Spinout/company page review", "Scripps Research technology development source for translational biology, diagnostics, and drug-discovery platform ventures."),
    Source("Georgia Tech spinouts", "University/spinout", "https://venturelab.gatech.edu/", "US", "Medium", "Quarterly", "Spinout/company page review", "Georgia Tech VentureLab source for medical devices, robotics, AI, sensors, and engineering-led health startups."),
    Source("Emory University spinouts", "University/spinout", "https://ott.emory.edu/", "US", "High", "Quarterly", "Spinout/company page review", "Emory Office of Technology Transfer source for clinical, diagnostics, digital health, and life-sciences ventures."),
    Source("Columbia University spinouts", "University/spinout", "https://ventures.columbia.edu/", "US", "High", "Quarterly", "Spinout/company page review", "Columbia Technology Ventures source for biomedical, AI, diagnostics, and medical technology startups."),
    Source("Cornell University spinouts", "University/spinout", "https://ctl.cornell.edu/", "US", "Medium", "Quarterly", "Spinout/company page review", "Cornell Center for Technology Licensing source for biomedical engineering, diagnostics, digital health, and life-sciences startups."),
    Source("Weill Cornell Medicine spinouts", "University/spinout", "https://ctl.weill.cornell.edu/", "US", "High", "Quarterly", "Spinout/company page review", "Weill Cornell Medicine technology licensing source for clinician-led diagnostics, therapeutics, digital health, and medical technology ventures."),
    Source("NYU spinouts", "University/spinout", "https://www.nyu.edu/research/resources-and-support-offices/technology-opportunities-and-ventures.html", "US", "High", "Quarterly", "Spinout/company page review", "NYU Technology Opportunities and Ventures source for health AI, devices, diagnostics, and clinical innovation startups."),
    Source("Carnegie Mellon spinouts", "University/spinout", "https://www.cmu.edu/cttec/", "US", "Medium", "Quarterly", "Spinout/company page review", "CMU CTTEC source for AI, robotics, software, sensors, and health-adjacent translational startups."),
    Source("University of Pittsburgh spinouts", "University/spinout", "https://www.innovation.pitt.edu/", "US", "High", "Quarterly", "Spinout/company page review", "Pitt Innovation Institute source for clinician-led medical device, diagnostics, therapeutics, and digital health startups."),
    Source("Rice University spinouts", "University/spinout", "https://oti.rice.edu/", "US", "Medium", "Quarterly", "Spinout/company page review", "Rice Office of Technology Transfer source for biomedical engineering, device, diagnostics, and health technology startups."),
    Source("Baylor College of Medicine spinouts", "University/spinout", "https://www.bcm.edu/research/office-of-research/industry-partnerships-and-technology-commercialization", "US", "High", "Quarterly", "Spinout/company page review", "Baylor College of Medicine commercialization source for translational clinical, diagnostics, and life-sciences ventures."),
    Source("Texas Medical Center Innovation", "University/spinout", "https://www.tmc.edu/innovation/", "US", "High", "Quarterly", "Spinout/company page review", "Texas Medical Center innovation ecosystem source for hospital-connected medtech, digital health, diagnostics, and clinical workflow companies."),
    Source("UT Austin spinouts", "University/spinout", "https://research.utexas.edu/otc/", "US", "Medium", "Quarterly", "Spinout/company page review", "UT Austin Office of Technology Commercialization source for AI, engineering, biomedical device, diagnostics, and digital health startups."),
    Source("MD Anderson spinouts", "University/spinout", "https://www.mdanderson.org/research/research-resources/office-of-technology-commercialization.html", "US", "High", "Quarterly", "Spinout/company page review", "MD Anderson technology commercialization source for oncology diagnostics, digital health, devices, and translational cancer ventures."),
    Source("Vanderbilt University spinouts", "University/spinout", "https://cttc.co/", "US", "High", "Quarterly", "Spinout/company page review", "Vanderbilt CTTC source for medical center-linked diagnostics, devices, digital health, and life-sciences startups."),
