...
ADAPTER_STATUS_NAMES = {
    ...
    "nhs_innovation_accelerator": "NHS Innovation Accelerator adapter",
    "nlc_health": "NLC Health adapter",
    "yesdelft_medtech": "YES!Delft MedTech adapter",
    "bioinnovation_institute": "BioInnovation Institute adapter",
    "nucleate_activator": "Nucleate Activator adapter",
    "cdl_health": "Creative Destruction Lab Health adapter",
    "mars_health": "MaRS Health Sciences adapter",
    "mars_ventureconnect": "MaRS VentureConnect snapshot adapter",
    "uoft_health_startups": "U of T Health & Life Sciences startup directory adapter",
    "tiap_portfolio": "TIAP portfolio adapter",
    "admare_portfolio": "adMare BioInnovations portfolio adapter",
    "centech_health": "Centech health startup API adapter",
    "cts_sante_portfolio": "CTS Santé portfolio sitemap adapter",
    "district3_health": "District 3 Healthcare/Biotech directory adapter",
    "obio_cohorts": "OBIO named health-science cohort adapter",
    "medteq_portfolio": "MEDTEQ+ investment portfolio adapter",
    "uceed_health": "Innovate Calgary / UCeed health-fund adapter",
    "ualberta_health_hub": "University of Alberta Health Innovation Hub adapter",
    "innovation_ubc_health": "Innovation UBC Human Health portfolio adapter",
    "mcgill_health_spinouts": "McGill health-sector spinoff adapter",
    "mcmaster_health_startups": "McMaster health startup showcase adapter",
    "axelys_supported_startups": "Axelys supported-startup index adapter",
    "velocity_health_companies": "Velocity Health company directory adapter",
    "lumira_portfolio": "Lumira Ventures life-sciences portfolio adapter",
    "genesys_portfolio": "Genesys Capital active healthcare portfolio adapter",
    "amplitude_portfolio": "Amplitude Ventures precision-medicine portfolio adapter",
    "bdc_health_portfolio": "BDC current health/life-sciences portfolio adapter",
    "facit_portfolio": "FACIT oncology investment portfolio adapter",
    "masschallenge_healthcare": "MassChallenge Healthcare adapter",
    "rockstart_health": "Rockstart Healthcare adapter",
    "sbri_healthcare": "SBRI Healthcare adapter",
    "eu_accelerator_directory": "Retired generic EU accelerator adapter",
    "sifted_ranking": "Sifted ranking adapter",
...
MARS_VENTURECONNECT_SNAPSHOT_PATH = "data/mars_ventureconnect_healthcare_life_sciences_2026-07-23.json"
JOB_BOARD_ADAPTERS = {
    "lever_jobs": "lever",
    "ashby_jobs": "ashby",
...
ACCELERATOR_SOURCE_PAGES = {
    ...
    "NHS Innovation Accelerator": ["https://nhsaccelerator.com/innovations/"],
    "NHS Clinical Entrepreneur Programme": ["https://nhscep.com/innovator-directory/"],
    "Startupbootcamp Digital Health": ["https://www.startupbootcamp.org/portfolio/"],
    "NLC Health": ["https://nlc.health/portfolio"],
    "YES!Delft MedTech": ["https://yesdelft.com/wp-json/wp/v2/startups?sectors=49&per_page=100"],
    "Bayer G4A": ["https://www.g4a.health/portfolio/"],
    "Roche Startup Creasphere": ["https://www.startupcreasphere.com/startups/"],
    "Novartis Biome": ["https://www.biome.novartis.com/solutions"],
    "Philips HealthWorks": ["https://www.philips.com/a-w/about/innovation/healthworks.html"],
    "Health Venture Lab": ["https://www.healthventurelab.eu/startups/"],
    "EIT Health Wild Card": ["https://eithealth.eu/programmes/wild-card/"],
    "BioInnovation Institute": ["https://bii.dk/api/content/GetProjects?focusarea=&program=&subareas=&sortorder=&from=0&num=250"],
    "SmiLe Incubator": ["https://www.smileincubator.life/companies/"],
    "HealthTech Nordic": ["https://www.healthtechnordic.com/companies/"],
    "Nucleate Activator": ["https://r.jina.ai/http://https://nucleate.org/companies"],
    "Creative Destruction Lab Health": ["https://creativedestructionlab.com/companies/"],
    "Rockstart Health": ["https://rockstart.com/portfolio/vertical-healthcare/", "https://rockstart.com/wp-json/wp/v2/portfolio?vertical=73&per_page=100"],
    "MassChallenge HealthTech": ["https://masschallenge.org/articles/healthcare-life-sciences-traction-cohort-2026/", "https://masschallenge.org/wp-json/wp/v2/articles/26235"],
    "SBRI Healthcare": [
        "https://sbrihealthcare.co.uk/impact-case-studies/company-directory",
        "https://sbrihealthcare.co.uk/impact-case-studies/company-directory/page:2",
        "https://sbrihealthcare.co.uk/impact-case-studies/company-directory/page:3",
        "https://sbrihealthcare.co.uk/impact-case-studies/company-directory/page:4",
        "https://sbrihealthcare.co.uk/impact-case-studies/company-directory/page:5",
    ],
    "Future4care": ["https://future4care.com/startups/"],
    "Wilco Healthcare": ["https://www.wilco-ambitions.com/startups/"],
    "DayOne": ["https://www.dayone.swiss/startups/"],
    "BaseLaunch": ["https://baselaunch.ch/portfolio/"],
    "Health Founders": ["https://healthfounders.ee/startups/"],
    "MEDVIA": ["https://www.medvia.be/en/members/"],
    "imec.istart Health": ["https://www.imecistart.com/en/portfolio"],
    "StartLife": ["https://start-life.nl/portfolio/"],
    "BioM": ["https://www.bio-m.org/en/for-startups/startup-database.html"],
    "BioRN": ["https://biorn.org/startups/"],
    "Life Science Factory": ["https://www.life-science-factory.com/en/startups/"],
    "Vision Health Pioneers": ["https://www.visionhealthpioneers.de/startups/"],
    "Medical Valley": ["https://www.medical-valley-emn.de/en/startups/"],
    "Helsinki Health Incubator": ["https://www.helsinkihealthincubator.fi/companies/"],
    "Terkko Health Hub": ["https://www.terkko.fi/community/"],
    "Barcelona Health Hub": ["https://www.barcelonahealthhub.com/members/startups/"],
    "EIT Health Bridgehead": ["https://eithealth.eu/programmes/bridgehead/"],
    "EIT Health Validation Labs": ["https://eithealth.eu/programmes/validation-lab/"],
    "EIT Health DRIVE": ["https://eithealth.eu/programmes/drive/"],
    "Oxford AHSN Accelerator": ["https://www.healthinnovationoxford.org/"],
    "Health Innovation Manchester": ["https://healthinnovationmanchester.com/"],
    "DigitalHealth.London Launchpad": ["https://digitalhealth.london/programmes/launchpad/"],
    "KQ Labs": ["https://www.crick.ac.uk/partnerships/translation/kq-labs"],
    "Cambridge Judge Accelerate": ["https://www.jbs.cam.ac.uk/entrepreneurship/programmes/accelerate-cambridge/"],
    "MedTech Innovator Europe": ["https://medtechinnovator.org/portfolio/"],
    "Norrsken Impact Accelerator Health": ["https://www.norrsken.org/accelerator"],
    "Antler Europe Health": ["https://www.antler.co/portfolio"],
    "Entrepreneur First Europe Health": ["https://www.joinef.com/companies/"],
    "Startup Wise Guys HealthTech": ["https://startupwiseguys.com/portfolio/"],
    "Founders Factory Health": ["https://foundersfactory.com/portfolio/"],
    "Zinc Health": ["https://www.zinc.vc/portfolio/"],
    "Bethnal Green Ventures Health": ["https://bethnalgreenventures.com/portfolio/"],
    "EIT Digital Health Startups": ["https://www.eitdigital.eu/our-community/scaleups/"],
    "InnoStars Awards": ["https://eithealth.eu/programmes/innostars-awards/"],
}
...
SOURCES: list[Source] = [
    ...
    Source("Sifted AI 100 2025", "Public ranking", "https://sifted.eu/rankings/ai-100-2025", "Europe", "Medium", "Annual", "Sifted ranking scan", "Sifted public AI ranking used as a health-first prioritization source; only health, biotech, medtech, diagnostics, SaMD, and clinical workflow entries become leads.", "sifted_ranking"),
    Source("Sifted Healthtech Investors 2025", "Investor prioritization", "https://sifted.eu/rankings/europes-most-active-investors-in-2025-healthtech", "Europe", "High", "Annual", "Sifted ranking scan", "Sifted healthtech investor ranking used to prioritize EU VC and accelerator source coverage; anonymized pages are logged as prioritization only.", "sifted_ranking"),
    ...
    Source("MaRS Health Sciences", "Accelerator", "https://www.marsdd.com/our-sectors/health/", "Canada", "High", "Quarterly", "Official health ventures API extraction", "Public MaRS Health venture directory covering Canadian biotech, medtech, diagnostics, and digital health companies.", "mars_health"),
    Source("MaRS VentureConnect Healthcare & Life Sciences", "Accelerator", "https://app.marsdd.com/companies?filter=%5B%22INDUSTRY%3AHEALTHCARE_AND_LIFE_SCIENCES%22%5D", "Canada", "High", "Quarterly", "Verified browser snapshot extraction", "Browser-verified MaRS VentureConnect Healthcare & Life Sciences directory snapshot; broad health universe for later medtech, funding, and hiring enrichment.", "mars_ventureconnect"),
    Source("Toronto Innovation Acceleration Partners (TIAP)", "Accelerator", "https://tiap.ca/portfolio/", "Canada", "High", "Quarterly", "Official static portfolio extraction", "TIAP venture-building portfolio from Toronto universities, hospitals, and research institutes; preserve active and exited status.", "tiap_portfolio"),
    Source("adMare BioInnovations", "Accelerator", "https://www.admarebio.com/en/companies-weve-helped-build", "Canada", "High", "Quarterly", "Official portfolio and company-detail extraction", "Canadian life-sciences companies adMare helped build plus current and past adMare Accelerator participants.", "admare_portfolio"),
    ...
    Source("MassChallenge HealthTech", "Accelerator", "https://masschallenge.org/articles/healthcare-life-sciences-traction-cohort-2026/", "US/global", "Medium", "Annual", "Cohort extraction", "Healthtech startups with provider/payer partnerships.", "masschallenge_healthcare"),
    ...
    Source("NHS Innovation Accelerator", "Accelerator", "https://nhsaccelerator.com/innovations/", "UK", "High", "Annual", "Fellow/innovation page extraction", "NHS-backed innovation accelerator for adopted healthcare innovations.", "nhs_innovation_accelerator"),
    ...
    Source("NLC Health", "Accelerator", "https://nlc.health/portfolio", "EU", "High", "Quarterly", "Venture/company page extraction", "European healthtech venture builder focused on health innovations.", "nlc_health"),
    Source("YES!Delft MedTech", "Accelerator", "https://yesdelft.com/wp-json/wp/v2/startups?sectors=49&per_page=100", "EU", "Medium", "Quarterly", "Startup/company page extraction", "Dutch deeptech accelerator with medtech and health startups.", "yesdelft_medtech"),
    ...
    Source("BioInnovation Institute", "Accelerator", "https://bii.dk/community/start-ups-projects/", "EU", "High", "Quarterly", "Portfolio/company page extraction", "Danish life-sciences incubator and venture source for biotech, diagnostics, medtech, and digital health startups.", "bioinnovation_institute"),
    Source("SmiLe Incubator", "Accelerator", "https://www.smileincubator.life/companies/", "EU", "High", "Quarterly", "Company directory extraction", "Nordic life-sciences incubator with diagnostics, biotech, digital health, and medtech companies.", "accelerator_page"),
    Source("HealthTech Nordic", "Accelerator", "https://www.healthtechnordic.com/companies/", "EU", "High", "Quarterly", "Company directory extraction", "Nordic digital health and healthtech company network. Current public domain appears parked/blocked; needs source replacement before automation.", "accelerator_page"),
    Source("Nucleate Activator", "Accelerator", "https://nucleate.org/companies", "EU/US/global", "High", "Annual", "Company directory extraction", "Academic biotech venture accelerator with launched diagnostics, therapeutics, medical device, and platform companies.", "nucleate_activator"),
    Source("Creative Destruction Lab Health", "Accelerator", "https://creativedestructionlab.com/companies/", "Canada", "High", "Annual", "Canadian-site health directory and company-detail extraction", "Toronto and Vancouver CDL companies in Health, Advanced Therapies, Biomedical Engineering, Cancer, Computational Health, Health & Wellness, Healthcare Delivery, Healthcare Robotics, Neuro, and related multi-stream cards; CDL site is a program-location signal, not verified company headquarters.", "cdl_health"),
    Source("Centech – Medtech", "Accelerator", "https://centech.co/en/startups-centech/", "Canada", "High", "Quarterly", "Official WordPress startup API extraction", "Centech startup records in BioTech, Digital Health, Medical Device, and Medtech categories; preserve repeat program/cohort records.", "centech_health"),
    Source("CTS Santé", "Accelerator", "https://ctssante.com/en/portfolio/", "Canada", "High", "Quarterly", "Official portfolio sitemap and company-page extraction", "Complete specialist health-technology portfolio.", "cts_sante_portfolio"),
    Source("District 3 – Bio and Health", "Accelerator", "https://www.district3.co/startups", "Canada", "High", "Quarterly", "Official paginated startup-directory extraction", "Healthcare and Biotech stream companies only.", "district3_health"),
    Source("OBIO", "Accelerator", "https://www.obio.ca/about-us", "Canada", "High", "Quarterly", "Official named cohort announcement extraction", "Publicly named WiHI and WeSEED health-science cohorts; OBIO has no public all-member company directory.", "obio_cohorts"),
    Source("MEDTEQ+", "Grant/funding", "https://www.medteq.ca/en/service/financing/", "Canada", "High", "Quarterly", "Official investment-portfolio extraction", "Company-level investment portfolio; funded projects are a separate project lead type and do not consistently expose company collaborators.", "medteq_portfolio"),
    Source("Innovate Calgary / UCeed Health", "Grant/funding", "https://innovatecalgary.com/programs-funding/uceed/", "Canada", "High", "Quarterly", "Official UCeed health-fund portfolio extraction", "Health Fund and Child Health and Wellness Fund company records.", "uceed_health"),
    Source("University of Alberta Health Innovation Hub", "University/spinout", "https://www.ualberta.ca/en/medicine/research/health-innovation-hub/companies.html", "Canada", "High", "Quarterly", "Official company-directory extraction with institutional preview fallback", "Health Innovation Hub company directory; production may return 403 while the official preview host remains public.", "ualberta_health_hub"),
    Source("Innovation UBC Human Health portfolio", "University/spinout", "https://innovation.ubc.ca/entrepreneurship-ventures/portfolio-companies", "Canada", "High", "Quarterly", "Official paginated Human Health portfolio extraction", "Human Health impact-area companies across spin-offs and supported ventures.", "innovation_ubc_health"),
    Source("McGill health-sector spinoffs", "University/spinout", "https://www.mcgill.ca/research/research/tech-transfer/spinoff-companies", "Canada: Québec", "High", "Quarterly", "Official sectorised spinoff-company extraction", "McGill companies with university-registered IP in the BioTech/MedTech and Pharmaceuticals sections.", "mcgill_health_spinouts"),
    Source("McMaster health startup showcase", "University/spinout", "https://entrepreneurship.mcmaster.ca/startups/", "Canada: Ontario", "High", "Quarterly", "Official startup showcase and native sector-filter extraction", "McMaster startup showcase companies returned by the official biotechnology, cancer, cell technology, diagnostics, digital health, drug discovery, health sciences, immuno-oncology, and medical-device filters.", "mcmaster_health_startups"),
    Source("Axelys supported startups", "University/spinout", "https://portfolio.axelys.ca/", "Canada: Québec", "High", "Quarterly", "Official public Startup-index extraction", "Shared Québec commercialization route for the Université de Montréal, CHUM, Sainte-Justine, Université Laval, and CHU de Québec clusters. Axelys does not expose institution of origin, so records remain cluster-level and are not attributed to a specific institution.", "axelys_supported_startups"),
    Source("Velocity Health company directory", "University/spinout", "https://www.velocityincubator.com/companies", "Canada: Ontario", "High", "Quarterly", "Official paginated Health-sector directory and detail-page extraction", "University of Waterloo-linked Velocity directory filtered to its native Health sector; Velocity participation is not proof of a formal university IP spinout.", "velocity_health_companies"),
    Source("Rockstart Health", "Accelerator", "https://rockstart.com/portfolio/vertical-healthcare/", "EU", "Medium", "Quarterly", "Healthcare portfolio extraction", "European accelerator portfolio filtered to healthcare vertical companies.", "rockstart_health"),
    Source("Accelerace Life Science", "Accelerator", "https://www.accelerace.io/", "EU", "Medium", "Quarterly", "Company/cohort extraction", "Danish accelerator with historical life-science activity; needs current official company directory before automation.", "accelerator_page"),
    Source("Pioneer Group Life Sciences", "Accelerator", "https://www.pioneergroup.com/", "UK", "Medium", "Quarterly", "Company directory extraction", "UK life-sciences campus and venture-building network; needs source-specific directory mapping.", "accelerator_page"),
    Source("MedTech SuperConnector", "Accelerator", "https://www.medtechsuperconnector.com/", "UK", "Medium", "Annual", "Cohort/company extraction", "London university-linked medtech accelerator; needs current official alumni/cohort page mapping.", "accelerator_page"),
    Source("NHS Innovation Service", "Accelerator", "https://innovation.nhs.uk/", "UK", "High", "Quarterly", "Innovation/company extraction", "NHS innovation support route; needs public company directory confirmation before automation.", "accelerator_page"),
    Source("Future4care", "Accelerator", "https://future4care.com/startups/", "EU", "High", "Quarterly", "Startup directory extraction", "French digital health accelerator and startup campus.", "accelerator_page"),
    Source("Wilco Healthcare", "Accelerator", "https://www.wilco-ambitions.com/startups/", "EU", "Medium", "Quarterly", "Startup directory extraction", "French healthcare startup accelerator and scaleup programme.", "accelerator_page"),
    Source("DayOne", "Accelerator", "https://www.dayone.swiss/startups/", "EU", "High", "Quarterly", "Startup directory extraction", "Swiss healthcare innovation accelerator focused on digital health, medtech, and life sciences.", "accelerator_page"),
    Source("BaseLaunch", "Accelerator", "https://baselaunch.ch/portfolio/", "EU", "High", "Quarterly", "Portfolio extraction", "Swiss biotech and life-sciences incubator and accelerator.", "accelerator_page"),
    Source("Health Founders", "Accelerator", "https://healthfounders.ee/startups/", "EU", "Medium", "Quarterly", "Startup directory extraction", "Estonian healthtech accelerator with digital health and clinical workflow startups.", "accelerator_page"),
    Source("MEDVIA", "Accelerator", "https://www.medvia.be/en/members/", "EU", "High", "Quarterly", "Member/company extraction", "Belgian medtech, biotech, and digital health innovation cluster.", "accelerator_page"),
    Source("imec.istart Health", "Accelerator", "https://www.imecistart.com/en/portfolio", "EU", "Medium", "Quarterly", "Portfolio extraction", "Belgian deeptech accelerator with digital health, medtech, and AI startups.", "accelerator_page"),
    Source("StartLife", "Accelerator", "https://start-life.nl/portfolio/", "EU", "Medium", "Quarterly", "Portfolio extraction", "Dutch life-sciences and food-health accelerator with biotech and health innovation companies.", "accelerator_page"),
    Source("BioM", "Accelerator", "https://www.bio-m.org/en/for-startups/startup-database.html", "EU", "Medium", "Quarterly", "Startup database extraction", "Munich biotech and life-sciences startup network.", "accelerator_page"),
    Source("BioRN", "Accelerator", "https://biorn.org/startups/", "EU", "Medium", "Quarterly", "Startup directory extraction", "Rhine-Neckar life-sciences cluster with biotech, diagnostics, and medtech startups.", "accelerator_page"),
    Source("Life Science Factory", "Accelerator", "https://www.life-science-factory.com/en/startups/", "EU", "Medium", "Quarterly", "Startup directory extraction", "German life-sciences incubator and startup hub.", "accelerator_page"),
    Source("Vision Health Pioneers", "Accelerator", "https://www.visionhealthpioneers.de/startups/", "EU", "High", "Annual", "Startup directory extraction", "Berlin digital health accelerator for clinical and patient-care startups.", "accelerator_page"),
    Source("Medical Valley", "Accelerator", "https://www.medical-valley-emn.de/en/startups/", "EU", "High", "Quarterly", "Startup directory extraction", "German medtech and digital health innovation cluster.", "accelerator_page"),
    Source("Helsinki Health Incubator", "Accelerator", "https://www.helsinkihealthincubator.fi/companies/", "EU", "Medium", "Quarterly", "Company directory extraction", "Finnish health incubator for diagnostics, digital health, and life-sciences startups.", "accelerator_page"),
    Source("Terkko Health Hub", "Accelerator", "https://www.terkko.fi/community/", "EU", "Medium", "Quarterly", "Community/company extraction", "Finnish health and life-sciences startup hub.", "accelerator_page"),
    Source("Barcelona Health Hub", "Accelerator", "https://www.barcelonahealthhub.com/members/startups/", "EU", "High", "Quarterly", "Startup member extraction", "Spanish digital health and healthcare innovation hub.", "accelerator_page"),
    Source("EIT Health Bridgehead", "Accelerator", "https://eithealth.eu/programmes/bridgehead/", "EU", "Medium", "Annual", "Programme/company extraction", "EIT Health market-access programme for European health startups.", "accelerator_page"),
    Source("EIT Health Validation Labs", "Accelerator", "https://eithealth.eu/programmes/validation-lab/", "EU", "Medium", "Annual", "Programme/team extraction", "EIT Health validation programme for early health ventures.", "accelerator_page"),
    Source("EIT Health DRIVE", "Accelerator", "https://eithealth.eu/programmes/drive/", "EU", "Medium", "Annual", "Programme/company extraction", "EIT Health programme for healthcare startups entering European markets.", "accelerator_page"),
    Source("Oxford AHSN Accelerator", "Accelerator", "https://www.healthinnovationoxford.org/", "UK", "Medium", "Quarterly", "Innovation/company extraction", "UK health innovation network source for adopted digital health and medtech innovations.", "accelerator_page"),
    Source("Health Innovation Manchester", "Accelerator", "https://healthinnovationmanchester.com/", "UK", "Medium", "Quarterly", "Innovation/company extraction", "UK health innovation network with clinical digital and medtech innovation programmes.", "accelerator_page"),
    Source("DigitalHealth.London Launchpad", "Accelerator", "https://digitalhealth.london/programmes/launchpad/", "UK", "Medium", "Annual", "Cohort/company extraction", "London early-stage digital health programme for NHS-facing startups.", "accelerator_page"),
    Source("KQ Labs", "Accelerator", "https://www.crick.ac.uk/partnerships/translation/kq-labs", "UK", "Medium", "Annual", "Cohort/company extraction", "London data-driven biomedical and health accelerator.", "accelerator_page"),
    Source("Cambridge Judge Accelerate", "Accelerator", "https://www.jbs.cam.ac.uk/entrepreneurship/programmes/accelerate-cambridge/", "UK", "Medium", "Quarterly", "Venture/company extraction", "Cambridge venture accelerator with healthtech, biotech, and medical technology startups.", "accelerator_page"),
    Source("MedTech Innovator Europe", "Accelerator", "https://medtechinnovator.org/portfolio/", "EU", "High", "Quarterly", "Portfolio extraction", "MedTech Innovator portfolio filtered for European medical device, diagnostics, and digital health companies.", "accelerator_page"),
    Source("Norrsken Impact Accelerator Health", "Accelerator", "https://www.norrsken.org/accelerator", "EU", "Medium", "Annual", "Portfolio/company extraction", "European impact accelerator with health, climate-health, and care-access startups.", "accelerator_page"),
    Source("Antler Europe Health", "Accelerator", "https://www.antler.co/portfolio", "EU", "Medium", "Quarterly", "Portfolio extraction", "European Antler portfolio filtered for health, medtech, biotech, and clinical workflow companies.", "accelerator_page"),
    Source("Entrepreneur First Europe Health", "Accelerator", "https://www.joinef.com/companies/", "EU/UK", "Medium", "Quarterly", "Company directory extraction", "European EF portfolio filtered for health AI, biotech, and regulated health technology companies.", "accelerator_page"),
    Source("Startup Wise Guys HealthTech", "Accelerator", "https://startupwiseguys.com/portfolio/", "EU", "Medium", "Quarterly", "Portfolio extraction", "European startup accelerator portfolio filtered for healthtech and medtech companies.", "accelerator_page"),
    Source("Founders Factory Health", "Accelerator", "https://foundersfactory.com/portfolio/", "UK/EU", "Medium", "Quarterly", "Portfolio extraction", "UK and European venture studio portfolio filtered for health startups.", "accelerator_page"),
    Source("Zinc Health", "Accelerator", "https://www.zinc.vc/portfolio/", "UK/EU", "Medium", "Quarterly", "Portfolio extraction", "UK venture builder with health, care, and wellbeing startups.", "accelerator_page"),
    Source("Bethnal Green Ventures Health", "Accelerator", "https://bethnalgreenventures.com/portfolio/", "UK/EU", "Medium", "Quarterly", "Portfolio extraction", "UK tech-for-good portfolio filtered for health and care companies.", "accelerator_page"),
    Source("EIT Digital Health Startups", "Accelerator", "https://www.eitdigital.eu/our-community/scaleups/", "EU", "Low", "Quarterly", "Scaleup/company extraction", "European digital scaleup network filtered for health and clinical workflow companies.", "accelerator_page"),
    Source("InnoStars Awards", "Accelerator", "https://eithealth.eu/programmes/innostars-awards/", "EU", "Medium", "Annual", "Awards/company extraction", "EIT Health InnoStars programme for emerging European health startups.", "accelerator_page"),
    ...
    Source("University of Toronto Health & Life Sciences startups", "University/spinout", "https://entrepreneurs.utoronto.ca/our-startups/startups-directory/", "Canada", "High", "Quarterly", "Official REST directory extraction", "Official U of T venture directory Health & Life Sciences category; retain category, accelerator, location, website, and company-size metadata.", "uoft_health_startups"),
    ...
    Source("Lumira Ventures portfolio", "VC portfolio", "https://www.lumiraventures.com/portfolio/", "Canada/global", "High", "Monthly", "Official current/exited portfolio extraction", "Life-sciences, biopharmaceutical and medical-device investments with headquarters metadata.", "lumira_portfolio"),
    Source("Genesys Capital portfolio", "VC portfolio", "https://www.genesyscapital.com/", "Canada/North America", "High", "Monthly", "Official active-investment index and detail extraction", "Active healthcare investments; placeholder and acquired/divested past-success cards excluded.", "genesys_portfolio"),
    Source("Amplitude Ventures portfolio", "VC portfolio", "https://amplitudevc.com/en/portfolio", "Canada/global", "High", "Monthly", "Embedded official precision-medicine portfolio extraction", "Active and exited precision-medicine companies with category, description, website and partnership metadata.", "amplitude_portfolio"),
    Source("BDC current health and life-sciences portfolio", "VC portfolio", "https://www.bdc.ca/en/bdc-capital/venture-capital/portfolio", "Canada", "High", "Monthly", "Official current portfolio sector-filter and detail extraction", "Direct current companies under Biotechnology, Devices, Digital Health, Drugs, Medical/Health and Healthcare Services; excludes BDC's fund-investment records.", "bdc_health_portfolio"),
    Source("FACIT oncology investment portfolio", "Grant/funding", "https://facit.ca/investment-portfolio", "Ontario, Canada", "High", "Monthly", "Official investment portfolio extraction", "Company-like oncology investments; explicitly excludes institution-owned pre-company assets while retaining pre-seed through exit records.", "facit_portfolio"),
    ...
    Source("SBRI Healthcare", "Grant/funding", "https://sbrihealthcare.co.uk/impact-case-studies/company-directory", "UK", "High", "Quarterly", "Competition/award review", "NHS-facing innovation awards and innovation portfolio directory.", "sbri_healthcare"),
...
EU_ACCELERATOR_PRIORITY_SOURCE_NAMES = [
    "MedTech Innovator",
    "EIT Health Catapult",
    ...
    "HealthTech Nordic",
    "Nucleate Activator",
    "Creative Destruction Lab Health",
    "Rockstart Health",
    "Accelerace Life Science",
    "Pioneer Group Life Sciences",
    ...
    "Medical Valley",
    "Helsinki Health Incubator",
    "Terkko Health Hub",
    "Barcelona Health Hub",
    "EIT Health Bridgehead",
    "EIT Health Validation Labs",
    "EIT Health DRIVE",
    "Oxford AHSN Accelerator",
    "Health Innovation Manchester",
    "DigitalHealth.London Launchpad",
    "KQ Labs",
    "Cambridge Judge Accelerate",
    "MedTech Innovator Europe",
    "Norrsken Impact Accelerator Health",
    "Antler Europe Health",
    "Entrepreneur First Europe Health",
    "Startup Wise Guys HealthTech",
    "Founders Factory Health",
    "Zinc Health",
    "Bethnal Green Ventures Health",
    "EIT Digital Health Startups",
    "InnoStars Awards",
]

EU_ACCELERATOR_IMPLEMENTED_BESPOKE_SOURCE_NAMES = [
    "MedTech Innovator",
    "EIT Health Catapult",
    "DigitalHealth.London Accelerator",
    "NHS Innovation Accelerator",
...
EU_ACCELERATOR_BESPOKE_BACKLOG_SOURCE_NAMES = [
    name
    for name in EU_ACCELERATOR_PRIORITY_SOURCE_NAMES
    if name not in EU_ACCELERATOR_IMPLEMENTED_BESPOKE_SOURCE_NAMES
]

PRIORITY_EU_VC_SOURCE_NAMES = [
    "Sofinnova Partners portfolio",
    "Fountain Healthcare Partners portfolio",
    "Seroba Life Sciences portfolio",
    "Atlantic Bridge portfolio",
    "Nina Capital portfolio",
    "Heal Capital portfolio",
    "Crista Galli Ventures portfolio",
    "MTIP portfolio",
    "Ysios Capital portfolio",
    "Kurma Partners portfolio",
    "BioGeneration Ventures portfolio",
    "EQT Life Sciences portfolio",
    "Forbion portfolio",
    "Gilde Healthcare portfolio",
    "Endeavour Vision portfolio",
    "SHS Capital portfolio",
    "Panakes Partners portfolio",
    "Vesalius Biocapital portfolio",
    "Asabys Partners portfolio",
    "AlbionVC healthcare portfolio",
]
